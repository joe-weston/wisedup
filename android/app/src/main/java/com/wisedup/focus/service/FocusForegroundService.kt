 ...
 * - On restart we re-read [com.wisedup.focus.data.FocusStateRepository] and self-stop if
 ...
 * - Notification channel is created in [WisedUpApplication.onCreate]; we just build into it.
 *
...
class FocusForegroundService : Service() {
    ...
    private fun verifyStateOrStop(): Job = scope.launch {
        val isActive = WisedUpApplication.get()
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, WisedUpApplication.CHANNEL_ID_FOCUS_MODE)
    ...
    companion object {
        const val ACTION_START = "com.wisedup.focus.action.START_FOCUS"
        const val ACTION_STOP = "com.wisedup.focus.action.STOP_FOCUS"
