 ...
 *    "volume HUD"-style transient overlays; we honor that by ignoring system UI events
...
class FocusAccessibilityService : AccessibilityService() {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (eventPkg == OUR_PACKAGE) return
        ...
        if (now - lastRelaunchElapsedMs < RELAUNCH_DEBOUNCE_MS) return
