...
Single-module Gradle project under `apps/android`. Reasonable package layout:
...
If multi-module is preferred later (R2+), split: `:core-data`, `:core-ui`, `:feature-onboarding`, `:feature-focus`, `:android`. Not needed for R1.
